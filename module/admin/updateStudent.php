...
if(!empty($_POST['submit'])){
    ...
    $sql = "UPDATE students SET id='$stuId', name='$stuName', password='$stuPassword', phone='$stuPhone', email='$stuEmail', gender='$stugender', dob='$stuDOB', addmissiondate='$stuAddmissionDate', address='$stuAddress', classid='$stuClassId' WHERE id='$stuId'";
